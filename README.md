...
- Building projects combining Linux, infrastructure and security.

### 🔐 Current Direction

`NETWORK SECURITY` · `LINUX` · `APPSEC` · `INFRASTRUCTURE`
...
Building a strong foundation in **Linux and networking**, with my main direction being **Network Security**.
